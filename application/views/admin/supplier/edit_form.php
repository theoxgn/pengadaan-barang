				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url("admin/supplier/edit") ?>" method="post"
							...
							<input type="hidden" name="id_supplier_barang" value="<?php echo $supplier->id_supplier_barang ?>" />

							<div class="form-group">
								<label for="supplier">Supplier Name*</label>
								<input class="form-control <?php echo form_error('supplier') ? 'is-invalid':'' ?>"
								 type="text" name="supplier" placeholder="Supplier name" value="<?php echo $supplier->supplier ?>" />
