...
class Product_model extends CI_Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['field' => 'id_kategori_barang',
            'label' => 'id_kategori_barang',
            'rules' => 'required'],

            ['field' => 'id_merk_barang',
            'label' => 'id_merk_barang',
            'rules' => 'required'],

            ['field' => 'id_supplier_barang',
            'label' => 'id_supplier_barang',
            'rules' => 'required'],
    ...
    public function save()
    {
        ...
        var_dump($this->db->insert($this->_table, $this));
    }
